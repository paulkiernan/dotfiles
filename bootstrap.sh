...
hg clone https://bitbucket.org/paul_kiernan/dotfiles
...
hg clone https://bitbucket.org/peerst/hgcollapse "$HOME/lib/hg/hgcollapse"
...
hg clone https://bitbucket.org/durin42/hgsubversion "$HOME/lib/hg/hgsubversion"
